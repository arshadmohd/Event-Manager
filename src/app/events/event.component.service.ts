...
import { IEvent, ISession } from '../shared/event.models';
...
export class EventListService {
  ...
  getMatchingSessions(matchText){
     var searchTerm =  matchText.toLowerCase();
     let result : ISession[] = [];
     for(let event of EVENTS){
        var foundSessions = event.sessions.filter((session)=>{
         ...
         result =  result.concat(foundSessions);   
     } 
